    ...
    >
      ...
      >
        ...
        <a
          ...
          className="w-full flex items-center justify-center gap-3 rounded-xl py-2.5 text-sm font-semibold border transition-all cursor-pointer hover:border-[var(--accent)]/40 hover:bg-[var(--surface-3)]"
